...
void	notify_window_active_pane_changed(struct window *, struct window_pane *);
...
void	control_notify_window_active_pane_changed(struct window *, struct window_pane *);
